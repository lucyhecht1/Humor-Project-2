      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            {(domains?.length ?? 0)} domains total
          </p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-200 bg-zinc-50/80 dark:border-zinc-700 dark:bg-zinc-800/50">
              ...
              <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Domain</th>
          ...
          <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
            {!domains?.length ? (
              <tr>
                <td colSpan={4} className="px-5 py-12 text-center text-sm text-zinc-500 dark:text-zinc-400">No domains found.</td>
              </tr>
            ) : (
              domains.map((d) => (
